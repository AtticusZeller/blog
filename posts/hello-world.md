...
This is a link to [[reinforcement-learning-basics]] and here's one with display text: [[transformer-attention|the attention mechanism]].

Cross-references work too: see [[hello-world]] for the intro.
...
> [!CAUTION]
> Wikilinks like `[[page]]` are auto-converted during sync. Do not use standard markdown links for internal posts — use wikilinks.
